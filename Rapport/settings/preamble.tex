...
\lstset{language=[LaTeX]tex,
	texcsstyle=*\bf\ttfamily\color{textblue},
	numbers=left,
	...
	extendedchars=false,
	morekeywords={double, int, true, false, boolean, pinMode, digitalWrite, begin, delay, listen, atan, float, return, char, flush, while, setup, Serial.begin, Serial.print, Serial.println, else, if, .read, available, void, loop},
