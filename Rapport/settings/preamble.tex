...
\definecolor{textblue}{rgb}{0,0,0.9}
\lstset{language=[LaTeX]tex,
	texcsstyle=*\ttfamily\color{textblue},
	numbers=left,
	numberstyle=\scriptsize,
	numbersep=5pt,
	breaklines=true,
	keywordstyle=\ttfamily\color{orange},	
	keywordstyle=[2]\ttfamily\color{textblue},
	comment=[l]{//},
	commentstyle=\color{darkgreen},
	extendedchars=false,
	morekeywords={double, int, true, false, boolean, pinMode, digitalWrite, begin, delay, listen, atan, float, return, char, flush, while, setup, Serial.begin, Serial.print, Serial.println, else, if, .read, available, void, loop, \#, define, byte, for, digitalRead, Serial, print, println, delayMicroseconds, int16_t},
	morekeywords=[2]{HIGH, LOW, INPUT, OUTPUT},
