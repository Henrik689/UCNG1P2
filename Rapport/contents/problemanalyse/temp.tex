...
Graf \ref{vandspild_graf_normal} viser et eksempel på hvordan temperaturændringerne forekommer, hvis det antages at vandspildet negliseres og temperaturen på røret derfor er lig med temperaturen i rummet. \fxnote{et vedlagt pris skema over hvor meget det koster?- har ikke kunne finde andet end det der var i projekt beskrivelsen}  
\\
\\
\begin{figure}[h!]
  \centering
...
\\
\\
Produktet skal kunne overvåge vandspildet uden at have regulerbare funktioner. Det skal kunne måle temperaturen i henholdvis rummet og overfladen på vandrøret, endvidere skal det kunne sammenligne de to temperature.\fxnote{skal produkt beskrivelsen stå så højt?}
\\
\\
