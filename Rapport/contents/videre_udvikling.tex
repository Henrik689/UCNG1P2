...
For at gøre systemet i stand til at kunne logge de målte og beregnede data, er der til dette projekt blevet valgt at bruge et Arduino Ethernet Shield for at forbinde Arduinoen med internettet, derudover er der blevet skrevet et stykke kode der gør det muligt for Arduinoen at uploade data til en SQL\footnote{Structured Query Language} database på nettet.
...
\img{figures/webguimain.png}{Hovedsiden af brugerinterfacet\fixme{opdatere billedet med ds18 data}}{webguimain}{1}\newline
